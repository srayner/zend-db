...
class Firebird implements DriverInterface, Profiler\ProfilerAwareInterface
{
    /**
     * @var Connection
     */
    ...
    public function checkEnvironment()
    {
        if (!extension_loaded('interbase')) {
            throw new Exception\RuntimeException('The interbase/firebird extension is required for this adapter but the extension is not loaded');
        }
    }
